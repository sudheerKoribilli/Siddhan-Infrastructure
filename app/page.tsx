        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="hidden md:flex items-center justify-between bg-gray-100/95 backdrop-blur-md rounded-full px-8 py-4 shadow-lg border border-gray-200">
            ...
            <div className="absolute left-1/2 transform -translate-x-1/2">
              <button onClick={() => handlePageChange("home")}>
                <Image
                  ...
                  width={160}
                  height={48}
                  className="w-55 h-12 hover:opacity-80 transition-opacity"
                />
              </button>
            </div>
            ...
            <Button
              ...
              className="bg-emerald-700 hover:bg-emerald-800 text-white px-6 py-2 rounded-full text-sm font-medium"
            >
              Get in touch
            </Button>
          </div>
          ...
          <div className="md:hidden bg-white/95 backdrop-blur-sm rounded-2xl px-6 py-4 shadow-lg border border-gray-200">
            ...
            {isMobileMenuOpen && (
              <div className="mt-4 pt-4 border-t border-gray-200 space-y-3 animate-in fade-in-0 duration-200">
                ...
                <Button
                  onClick={() => handlePageChange("contact")}
                  className="w-full bg-emerald-700 hover:bg-emerald-800 text-white rounded-full text-sm font-medium mt-4"
                >
                  Get in touch
                </Button>
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg">
                ...
                <form className="space-y-6">
                  ...
                  <Button className="w-full bg-emerald-700 hover:bg-emerald-800 text-white py-3 rounded-lg font-medium">
                    Send Message
                  </Button>
                </form>
              </div>
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
              <div className="text-center">
                ...
                <div className="animate-in fade-in-0 duration-700 delay-300">
                  <Button
                    asChild
                    className="bg-teal-700 hover:bg-teal-800 text-white px-8 py-3 rounded-full text-lg font-semibold group hover:scale-105 transition-all duration-200"
                  >
                    <a href="#contact-form">
                      Book an appointment
        ...
        <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <section className="py-24 bg-gray-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                <div className="text-sm font-semibold text-emerald-700 mb-4 tracking-wider uppercase">
                  Our Expertise
                </div>
          ...
          <section className="py-32 bg-teal-800 text-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <>
          ...
          <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 bg-gradient-to-br from-gray-900 to-gray-800">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              ...
              >
                <div className="text-sm font-semibold text-teal-400 mb-4 tracking-wider">CONSTRUCTION DIVISION</div>
                <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold mb-6 leading-tight">
                  <span className="block">Building Tomorrow's</span>
                  <span className="block text-teal-400">Infrastructure</span>
                </h1>
              ...
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                ...
                >
                  ...
                  <h2 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                    25+ Years of
                    <br />
                    <span className="text-teal-700">Construction Excellence</span>
                  </h2>
                ...
                >
                  ...
                  <div className="absolute -bottom-6 -right-6 bg-teal-700 text-white p-6 rounded-2xl shadow-xl">
          ...
          <section className="py-20 bg-gray-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <motion.div
                ...
                className="text-center mb-16"
              >
                <div className="text-sm font-semibold text-teal-700 mb-4 tracking-wider">OUR CONSTRUCTION SERVICES</div>
                <h2 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-8">
                  Comprehensive Construction
                  <br />
                  <span className="text-teal-700">Solutions</span>
                </h2>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                ...
                <h2 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-8">
                  Our Construction
                  <br />
                  <span className="text-teal-700">Portfolio</span>
                </h2>
              </motion.div>
              ...
              <motion.div
                ...
                transition={{ duration: 0.8 }}
                viewport={{ once: true }}
                className="grid md:grid-cols-4 gap-8 bg-teal-700 rounded-2xl p-8 text-white"
              >
                {[
          ...
          <section className="py-20 bg-gray-900 text-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <motion.div
                ...
                className="text-center mb-16"
              >
                <div className="text-sm font-semibold text-teal-400 mb-4 tracking-wider">OUR PROCESS</div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                {[
                  ...
                  >
                    <div className="w-16 h-16 bg-teal-600 rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-4">
                      {process.step}
                    </div>
          ...
          <section className="py-20 bg-teal-700">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Button className="bg-white text-teal-700 hover:bg-gray-100 px-8 py-3 rounded-full text-lg font-semibold">
                    Get Free Quote
                  </Button>
                  <Button
                    variant="outline"
                    className="border-white text-white hover:bg-white hover:text-teal-700 px-8 py-3 rounded-full text-lg font-semibold bg-transparent"
                  >
                    Schedule Consultation
                  </Button>
                </div>
        ...
        <>
          ...
          <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              ...
              >
                <div className="text-sm font-semibold text-amber-700 mb-4 tracking-wider">INTERIOR DESIGN DIVISION</div>
                <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold mb-6 leading-tight">
                  <span className="block">Crafting Beautiful</span>
                  <span className="block text-amber-700">Living Spaces</span>
                </h1>
                <p className="text-xl text-gray-700 mb-8 max-w-3xl mx-auto leading-relaxed">
                  Transform your space into a masterpiece with our award-winning interior design team. We create
                  environments that reflect your personality while maximizing functionality and aesthetic appeal.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Button className="bg-amber-600 hover:bg-amber-700 text-white px-8 py-3 rounded-full text-lg font-semibold">
                    View Our Designs
                  </Button>
                  <Button
                    variant="outline"
                    className="border-amber-600 text-amber-700 hover:bg-amber-600 hover:text-white px-8 py-3 rounded-full text-lg font-semibold bg-transparent"
                  >
                    Free Consultation
                  </Button>
                </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <div className="text-sm font-semibold text-amber-700 mb-4 tracking-wider">
                    ABOUT OUR INTERIOR DESIGN DIVISION
                  </div>
                  <h2 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                    Award-Winning
                    <br />
                    <span className="text-amber-700">Interior Design</span>
                  </h2>
                  <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                ...
                >
                  <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                    <Image
                      src="/placeholder.svg?key=interior1"
                      alt="Luxury interior design showcase"
                      width={800}
                      height={600}
                      className="w-full h-auto object-cover"
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                ...
                <h2 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-8">
                  Complete Interior
                  <br />
                  <span className="text-amber-700">Design Solutions</span>
                </h2>
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                ...
                {[
                  {
                    ...
                    image: "/placeholder.svg?key=residential",
                  ...
                  },
                  {
                    ...
                    image: "/placeholder.svg?key=commercial",
                  ...
                  },
                  {
                    ...
                    image: "/placeholder.svg?key=planning",
                  ...
                  },
                  {
                    ...
                    image: "/placeholder.svg?key=color",
                  ...
                  },
                  {
                    ...
                    image: "/placeholder.svg?key=furniture",
          ...
          <section className="py-20 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <motion.div
                ...
                className="text-center mb-16"
              >
                <div className="text-sm font-semibold text-amber-700 mb-4 tracking-wider">FEATURED DESIGNS</div>
                <h2 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-8">
                  Our Interior Design
                  <br />
                  <span className="text-amber-700">Portfolio</span>
                </h2>
              </motion.div>
              ...
              <div className="grid lg:grid-cols-3 gap-8 mb-12">
                ...
                >
                  <Image
                    src="/images/testimonial-room.jpg"
                  ...
                  {[
                    {
                      ...
                      image: "/placeholder.svg?key=office",
                    },
                    {
                ...
                {[
                  {
                    ...
                    image: "/placeholder.svg?key=kitchen",
                  },
                  {
                    title: "Luxury Master Bedroom",
                    category: "Residential",
                    image: "/placeholder.svg?key=bedroom",
                  },
                  {
                    title: "Contemporary Bathroom",
                    category: "Residential",
                    image: "/placeholder.svg?key=bathroom",
                  },
                  {
              ...
              <motion.div
                ...
                transition={{ duration: 0.8 }}
                viewport={{ once: true }}
                className="grid md:grid-cols-4 gap-8 bg-amber-700 rounded-2xl p-8 text-white mt-16"
              >
                {[
          ...
          <section className="py-20 bg-gradient-to-br from-amber-50 to-orange-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <motion.div
                ...
                className="text-center mb-16"
              >
                <div className="text-sm font-semibold text-amber-700 mb-4 tracking-wider">OUR DESIGN PROCESS</div>
                <h2 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-8">
                  How We Create
                  <br />
                  <span className="text-amber-700">Beautiful Spaces</span>
                </h2>
              </motion.div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8">
                {[
                  ...
                  >
                    <div className="w-16 h-16 bg-amber-600 rounded-full flex items-center justify-center text-2xl font-bold text-white mx-auto mb-4">
                      {process.step}
                    </div>
          ...
          <section className="py-20 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <motion.div
                ...
                className="text-center mb-16"
              >
                <div className="text-sm font-semibold text-amber-700 mb-4 tracking-wider">CLIENT TESTIMONIALS</div>
                <h2 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-8">
                  What Our Clients
                  <br />
                  <span className="text-amber-700">Say About Us</span>
                </h2>
              </motion.div>
          ...
          <section className="py-20 bg-amber-700">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Button className="bg-white text-amber-700 hover:bg-gray-100 px-8 py-3 rounded-full text-lg font-semibold">
                    Free Consultation
                  </Button>
                  <Button
                    variant="outline"
                    className="border-white text-white hover:bg-white hover:text-amber-700 px-8 py-3 rounded-full text-lg font-semibold bg-transparent"
                  >
                    View Portfolio
                  </Button>
                </div>
            ...
            <div className="md:col-span-2">
              <div className="flex items-center space-x-2 mb-4">
                <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center">
                  <span className="text-teal-900 font-bold text-lg">S</span>
                </div>
